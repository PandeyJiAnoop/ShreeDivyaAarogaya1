package com.sign.akp_shreedivyaaarogya.ActivationArea;
...
public class AA_FundHistory extends AppCompatActivity {
    ...
    public void  TopupDetails(){
        String otp1 = new GlobalAppApis().GetFundHistory(UserId);
        ApiService client1 = getApiClient_ByPost();
        Call<String> call1 = client1.getFundRequestReport(otp1);
        new ConnectToRetrofit(new RetrofitCallBackListenar() {
            @Override
            public void RetrofitCallBackListenar(String result, String action) throws JSONException {
                Log.d("getFundRequestReport",result);
                try {
                    ...
                    for (int i = 0; i < Jarray.length(); i++) {
                        ...
                        hm.put("EntryDate1", jsonObject1.getString("EntryDate1"));
    ...
    public class FundistoryAdapter extends RecyclerView.Adapter<FundistoryAdapter.VH> {
        ...
        public void onBindViewHolder(@NonNull FundistoryAdapter.VH vh, int i) {
            ...
            vh.tv1.setText(arrayList.get(i).get("EntryDate1"));
            vh.tv2.setText(arrayList.get(i).get("Remark"));
            vh.tv3.setText(arrayList.get(i).get("PaymentStatus"));
