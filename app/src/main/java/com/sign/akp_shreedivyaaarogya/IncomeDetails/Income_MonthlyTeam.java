...
public class Income_MonthlyTeam extends AppCompatActivity {
    ImageView menuImg;
    String UserId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_income_monthly_team);
        ...
        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(Income_MonthlyTeam.this)) {
                    ...
                    Toast.makeText(Income_MonthlyTeam.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                } }});
        TopupDetails(UserId);
    }
...
//                        String language = getDetails.getString("CustomerAccountId");
                    ...
                    GridLayoutManager gridLayoutManager = new GridLayoutManager(Income_MonthlyTeam.this, 1);
                    Income_MonthlyTeam.ActivationAdapter walletHistoryAdapter = new Income_MonthlyTeam.ActivationAdapter(Income_MonthlyTeam.this, arrayList);
        ...
        }, Income_MonthlyTeam.this, call1, "", true); }





    public class ActivationAdapter extends RecyclerView.Adapter<Income_MonthlyTeam.ActivationAdapter.VH> {
        Context context;
        ...
        @NonNull
        @Override
        public Income_MonthlyTeam.ActivationAdapter.VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(context).inflate(R.layout.dynamic_monthlyincome, viewGroup, false);
            Income_MonthlyTeam.ActivationAdapter.VH viewHolder = new Income_MonthlyTeam.ActivationAdapter.VH(view);
            return viewHolder;
        }
        @Override
        public void onBindViewHolder(@NonNull Income_MonthlyTeam.ActivationAdapter.VH vh, int i) {
