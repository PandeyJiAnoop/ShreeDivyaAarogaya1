...
public class OutboxActivity extends AppCompatActivity {
    ...
    public void  TopupDetails(String CustomerId){
        String otp1 = new GlobalAppApis().Outbox(CustomerId);
        ApiService client1 = getApiClient_ByPost();
        Call<String> call1 = client1.GetCustomerOutboxDetails(otp1);
        new ConnectToRetrofit(new RetrofitCallBackListenar() {
            @Override
            public void RetrofitCallBackListenar(String result, String action) throws JSONException {
                Log.d("GetCustomerOutboxDetails",result);
                try {
