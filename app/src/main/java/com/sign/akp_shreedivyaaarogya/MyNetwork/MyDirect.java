    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(MyDirect.this)) {
                    ...
                    Toast.makeText(MyDirect.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                        String language = getDetails.getString("CustomerAccountId");
                    ...
                    GridLayoutManager gridLayoutManager = new GridLayoutManager(MyDirect.this, 1);
                    ReferralAdapter walletHistoryAdapter = new ReferralAdapter(MyDirect.this, arrayList);
